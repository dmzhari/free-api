...
<head>
    ...
    <title>EcchiExploit Api Free</title>
    ...
    <div class="container">
        <div class="row justify-content-center mt-5">
            <div class="card border-0">
                <h3 class="text-center font-italic">Free <span class="text-primary">Api</span></h3>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped table-hover table-condensed">
                            <thead class="font-weight-bold table-info text-center">
                                <tr>
                                    <th>No</th>
                                    <th>Name</th>
                                    <th>Query</th>
